...
if __name__ == "__main__":
    ...
    try:
        ...
        if args.task == "strategy":
            ...
            df_summary, dt_details, _ = get_option_strategies_info(client, df_strikes, settings)
            ...
            df_summary, dt_details, df_warning = get_option_holdings_info(client, settings)
